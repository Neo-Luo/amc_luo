...
var invpu_lists = "<?=site_url('invpulack/lists')?>";
var invpu_add   = "<?=site_url('invpulack/add')?>";
var invpu_edit   = "<?=site_url('invpulack/edit')?>";
var invpu_info   = "<?=site_url('invpulack/info')?>";
var invpu_del    = "<?=site_url('invpulack/del')?>";
var invpu_export  = "<?=site_url('invpulack/export')?>";
</script>
<style>
...
<script src="<?=skin_url()?>/js/dist/lackList.js?2"></script>
</body>
</html>