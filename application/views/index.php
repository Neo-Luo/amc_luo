...
function markupVension(){
	var imgSrcList = {
				base:'<?=skin_url()?>/css/blue/img/icon_v_b.png',	
				baseExp:'<?=skin_url()?>/css/blue/img/icon_v_b_e.png',	
				baseTrial:'<?=skin_url()?>/css/blue/img/icon_v_b_t.png',	
				standard:'<?=skin_url()?>/css/blue/img/icon_v_s.png', 
				standardExp:'<?=skin_url()?>/css/blue/img/icon_v_s_e.png', 
				standardTrial :'<?=skin_url()?>/css/blue/img/icon_v_s_t.png' 
			};
...
<div id="container" class="cf">
  <div id="col-side">
    ...
    <ul id="nav" class="cf">
    <li class="item item-vip"> <a href="javascript:void(0);" class="vip main-nav"><span class="arrow">&gt;</span></a>
...
//	},
	receipt: {
		name: "应收账款",
		href: "<?=site_url('scm/index')?>",//href: "/scm/receipt.do?action=initReceipt",
		dataRight: "SA_QUERY",
		target: "money"
	},
	receiptList: {
		name: "销售业务账",
		href: "<?=site_url('scm/index2')?>",//href: "/scm/receipt.do?action=initReceiptList",
		dataRight: "RECEIPT_QUERY",
		target: "money"
	},
	payment: {
		name: "应付账款",
		href: "<?=site_url('scm/index3')?>",//href: "/scm/payment.do?action=initPay",
		dataRight: "PAYMENT_ADD",
		target: "money"
	},
	paymentList: {
		name: "采购业务账",
		href: "<?=site_url('scm/index4')?>",//href: "/scm/payment.do?action=initPayList",
