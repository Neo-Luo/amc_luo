    ...
    <div id="manage-wrap" class="manage-wrap">
    	<form id="manage-form" action="">
    		<ul class="mod-form-rows base-form cf" id="base-form">
				...
				<li class="row-item">
    				<div class="label-wrap"><label for="safequantity">安全库存</label></div>
    				<div class="ctn-wrap"><input type="text" value="" class="ui-input" name="safequantity" id="safequantity" /></div>
    			</li>
				<li class="row-item">
    				<div class="label-wrap"><label for="safelevel">库存水平</label></div>
    				<div class="ctn-wrap"><input type="text" value="" class="ui-input" name="safelevel" id="safelevel" /></div>
    			</li>
    		</ul>
