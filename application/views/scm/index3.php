...
var scm_lists3 = "<?=site_url('scm/lists3')?>";
var scm_turningto4 = "<?=site_url('scm/turningto4')?>";
...
<div class="wrapper">
  <div class="mod-search cf">
    ...
    <div class="fr">
      <a class="ui-btn ui-btn-sp" id="turning" target="_blank" href="javascript:void(0);">转账</a>
...
<script src="<?=skin_url()?>/js/dist/scmList3.js?2"></script>
</body>
</html>