...
var invoi_outmanagement = "<?=site_url('invoi/outmanagement')?>"
...
var invoi_turningto1 = "<?=site_url('invoi/turningto1')?>";
var invoi_turningto2 = "<?=site_url('invoi/turningto2')?>";
...
<div class="wrapper">
  <div class="mod-search cf">
    ...
    <div class="fr"><a class="ui-btn ui-btn-sp" id="turningto2">确认出库</a>&nbsp;&nbsp;&nbsp;&nbsp;<a class="ui-btn ui-btn-sp" id="add">新增</a><!--<a class="ui-btn" id="export">导出</a>--></div>
  </div>
  <div class="grid-wrap">
    <table id="grid">
    </table>
...
<script src="<?=skin_url()?>/js/dist/otherOutbound.js?s22"></script>
</body>
</html>