...
var invoi_inmanagement = "<?=site_url('invoi/inmanagement')?>";
...
<div class="wrapper">
  <div class="mod-search cf">
    ...
    <div class="fr"><a class="ui-btn ui-btn-sp" id="turningto1">确认入库</a>&nbsp;&nbsp;&nbsp;&nbsp;<a class="ui-btn ui-btn-sp" id="add">新增</a><!--<a class="ui-btn" id="export">导出</a>--></div>
  </div>
  <div class="grid-wrap">
    <table id="grid">
    </table>
...
<script src="<?=skin_url()?>/js/dist/otherWarehouse.js?s22"></script>
</body>
</html>