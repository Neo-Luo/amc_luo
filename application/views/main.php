    ...
    <div class="main-wrap cf">
      ...
      <ul class="quick-links">
        ...
        <li class="storage-transfers">
        	<a tabid="storage-transfers" data-right="TF_ADD" tabTxt="运输管理" parentOpen="true" rel="pageTab11" href="#"><span></span>运输管理</a>
        </li>
        ...
        <li class="storage-otherWarehouse">
        	<a tabid="storage-otherWarehouse" data-right="IO_ADD" tabTxt="应收账款" parentOpen="true" rel="pageTab" href="<?=site_url('scm/index')?>"><span></span>应收账款</a>
        </li>
        <li class="storage-otherOutbound">
        	<a tabid="storage-otherOutbound" data-right="OO_ADD" tabTxt="应付账款" parentOpen="true" rel="pageTab" href="<?=site_url('scm/index3')?>"><span></span>应付账款</a>
        </li>
        <li class="added-service">
        	<a tabid="setting-addedServiceList" tabTxt="辅助资料" parentOpen="true" rel="pageTab111" href="#"><span></span>辅助资料</a>
        </li>
        <li class="feedback">
        	<a href="<?=site_url('logs')?>" id="feedback111"><span></span>操作日志</a>
        </li>
      </ul>
    </div>
  </div>
